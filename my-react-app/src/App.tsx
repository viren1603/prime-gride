              ...
              {columns.map((col, index) => (
                <td
                  ...
                  style={{
                    ...
                    maxWidth: col.width ? `${col.width}px` : "100px", // Ensuring it respects column width
                  }}
                  title={
                    summaryIndex[index] !== undefined
                      ? String(summaryIndex[index])
                      : ""
                  } // Show full text on hover
                >
                  {summaryIndex[index] !== undefined ? summaryIndex[index] : ""}
                </td>
              ))}
              {/* <ExtraSummaryBox /> */}
            </>
